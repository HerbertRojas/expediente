<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
    <div class="brand-sidebar">
        <h1 class="logo-wrapper">
            <a class="brand-logo darken-1" href="index.html">
                ...
                <span class="logo-text hide-on-med-and-down">Expedientes</span>
            </a>
    ...
    <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
        <li class="@if(Request::is('home')) active @endif bold">
            <a class="waves-effect waves-cyan @if(Request::is('home')) active @endif" href="{{ url('/home') }}">
                <i class="material-icons">settings_input_svideo</i>
                <span class="menu-title" data-i18n="Dashboard">Dashboard</span>
            </a>
        </li>
        <li class="@if(Request::is('roles')) active @endif bold">
            <a class="waves-effect waves-cyan @if(Request::is('roles')) active @endif" href="{{ route('roles.index') }}">
                <i class="material-icons">work</i>
                <span class="menu-title" data-i18n="Work">Roles</span>
            </a>
        </li>
        <li class="@if(Request::is('usuarios')) active @endif bold">
            <a class="waves-effect waves-cyan @if(Request::is('usuarios')) active @endif" href="{{ route('usuarios.index') }}">
